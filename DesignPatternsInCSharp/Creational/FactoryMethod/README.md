...
## 1) Intent
Defer object creation to factory classes/subclasses.

## 2) Problem it solves
Client code should not know concrete types during creation.

## 3) Core idea
Define creator abstraction with overridable factory method.

## 4) Participants in this example
NotificationFactory, EmailFactory, INotification

## 5) Step-by-step flow
- Define product interface.
- Create concrete product implementations.
- Define abstract creator/factory method.
- Use creator from client code.
