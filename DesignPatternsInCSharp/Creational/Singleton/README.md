...
## 1) Intent
Ensure exactly one instance with a global access point.

## 2) Problem it solves
Multiple instances of a shared service can cause inconsistent state.

## 3) Core idea
Hide constructor and expose one static instance.
...
- Expose static readonly/lazy instance.
- Use single instance across application.
- Guard against accidental multiple creation.
